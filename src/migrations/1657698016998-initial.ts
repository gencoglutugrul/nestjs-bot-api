...
export class Initial1657698016998 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "request_entity" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "username" varchar NOT NULL, "loginUrl" varchar NOT NULL, "jobId" integer NOT NULL, CONSTRAINT "REL_64ca6d83afbcf88b662e4f03de" UNIQUE ("jobId"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "job_entity" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "type" varchar(255) NOT NULL, "processedOn" datetime, "finishedOn" datetime, "result" varchar, "isCompleted" boolean NOT NULL DEFAULT (0), "isFailed" boolean NOT NULL DEFAULT (0))`,
    );
    await queryRunner.query(
      `CREATE TABLE "temporary_request_entity" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "username" varchar NOT NULL, "loginUrl" varchar NOT NULL, "jobId" integer NOT NULL, CONSTRAINT "REL_64ca6d83afbcf88b662e4f03de" UNIQUE ("jobId"), CONSTRAINT "FK_64ca6d83afbcf88b662e4f03de7" FOREIGN KEY ("jobId") REFERENCES "job_entity" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
